...
export default function Header() {
    const {createUser, setShowCart, isMenuOpen, setIsMenuOpen, userCart} = useContext(UserContext)
    const dropDownTransition = useTransition(isMenuOpen, {
    ...
    return (
        ...
        <header>
            ...
            <div 
                ...
                onClick={() => openMenu()}
                >
                <div className={`hamburger-section ${isMenuOpen && 'active-1'}`}></div>
                <div className={`hamburger-section ${isMenuOpen && 'active-2'}`}></div>
                <div className={`hamburger-section ${isMenuOpen && 'active-3'}`}></div>
            </div>
        ...
        {dropDownTransition((style, item) => {
            return item ? 
                ...
                >
                    <span className="backdrop-drop-down" onClick={closeDropDown}></span> 
                </animated.div>:
                null
        })}
        </animated.div>
